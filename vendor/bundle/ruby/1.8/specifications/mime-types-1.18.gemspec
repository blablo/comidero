...
:include: Licence.rdoc}
  ...
  s.extra_rdoc_files = [%q{History.rdoc}, %q{Licence.rdoc}, %q{Manifest.txt}, %q{README.rdoc}, %q{type-lists/application.txt}, %q{type-lists/audio.txt}, %q{type-lists/image.txt}, %q{type-lists/message.txt}, %q{type-lists/model.txt}, %q{type-lists/multipart.txt}, %q{type-lists/text.txt}, %q{type-lists/video.txt}]
  s.files = [%q{History.rdoc}, %q{Licence.rdoc}, %q{Manifest.txt}, %q{README.rdoc}, %q{type-lists/application.txt}, %q{type-lists/audio.txt}, %q{type-lists/image.txt}, %q{type-lists/message.txt}, %q{type-lists/model.txt}, %q{type-lists/multipart.txt}, %q{type-lists/text.txt}, %q{type-lists/video.txt}]
